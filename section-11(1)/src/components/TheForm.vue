...
export default {
  ...
  methods: {
    submitForm() {
      ...
      this.userName = '';
      console.log('UserAge: ');
      console.log(this.userAge + 5); // number: 32+5=37
      console.log(this.$refs.ageInput.value + 5); // String: 32+5=325
      console.log(31);
      this.userAge = null;
      ...
      this.how = null;
      console.log('Confirm?')
      console.log(this.confirm) // single checkbox will get true or false. multiple checkbox will get array value
      this.confirm = false
      console.log('Rating: ')
